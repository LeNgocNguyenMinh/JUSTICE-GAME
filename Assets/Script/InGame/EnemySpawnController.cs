...
public class EnemySpawnController : MonoBehaviour
{
    ...
    private void SpawnEnemy(SpawnPos spawnPos)
    {
        switch(spawnPos)
        {
            case SpawnPos.RHigh:
                ...
                break;
            case SpawnPos.RLow:
                enemy = Instantiate(onGroundEnemyPrefabs, EnemySpawnPoints.Instance.rLowStartPoint.position, Quaternion.identity);
                scale = enemy.transform.localScale;
                scale.x *= -1;
                enemy.transform.localScale = scale;
                enemy.GetComponent<Enemy>().SetStartValue();
            ...
            case SpawnPos.LHigh:
                ...
                break;
            case SpawnPos.LLow:
                enemy = Instantiate(onGroundEnemyPrefabs, EnemySpawnPoints.Instance.lLowStartPoint.position, Quaternion.identity);
                enemy.GetComponent<Enemy>().SetStartValue();
                enemyOnField.Add(enemy);
                break;
            ...
            case SpawnPos.LowBoth:
                enemy1 = Instantiate(onGroundEnemyPrefabs, EnemySpawnPoints.Instance.rLowStartPoint.position, Quaternion.identity);
                scale = enemy1.transform.localScale;
                scale.x *= -1;
                enemy1.transform.localScale = scale;
                enemy2 = Instantiate(onGroundEnemyPrefabs, EnemySpawnPoints.Instance.lLowStartPoint.position, Quaternion.identity);
                enemy1.GetComponent<Enemy>().SetStartValue();
                enemy2.GetComponent<Enemy>().SetStartValue();
                enemyOnField.Add(enemy1);
                enemyOnField.Add(enemy2);
