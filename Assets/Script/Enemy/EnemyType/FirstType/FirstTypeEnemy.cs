...
public class FirstTypeEnemy : Enemy
{
    ...
    public override void SetStartValue()
    {
        ...
        {
            endPos = EnemySpawnPoints.Instance.lHightDesPoint.position;
            direct = (EnemySpawnPoints.Instance.lHightDesPoint.position - EnemySpawnPoints.Instance.lHightStartPoint.position).normalized;
        }
        else{
            endPos = EnemySpawnPoints.Instance.rHightDesPoint.position;
            direct = (EnemySpawnPoints.Instance.rHightDesPoint.position - EnemySpawnPoints.Instance.rHightStartPoint.position).normalized;
        }
